...
const AlianzaIMIN = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      applications: [
        { icon: Store, text: 'Retail y supermercados' },
    ...
    },
    {
      ...
      applications: [
        { icon: Store, text: 'Grandes cadenas' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section - Green + Orange IMIN colors */}
      <section className="relative bg-gradient-to-br from-green-600 via-emerald-600 to-orange-500 text-white py-20 overflow-hidden">
      ...
      {/* Alliance Features - 50% más pequeño */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {allianceFeatures.map((feature, index) => (
              <Card 
                key={index} 
                className="border-2 border-orange-100 hover:border-orange-300 hover:shadow-lg transition-all duration-300 group"
              >
                <CardContent className="p-6">
                  <div className="bg-gradient-to-br from-green-100 to-orange-100 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:from-green-600 group-hover:to-orange-500 transition-colors">
                ...
                <button
                  ...
                  className={`p-4 rounded-xl border-2 transition-all duration-300 flex flex-col items-center gap-2 ${
                    selectedCategory === cat.id
                      ? 'border-orange-500 bg-gradient-to-br from-green-50 to-orange-50 shadow-lg'
      ...
      {/* Products Section - Contenedores más compactos */}
              ...
              >
                <CardContent className="p-0">
                  <div className="grid md:grid-cols-2 gap-0">
                    {/* Image Section - Imagen más grande */}
                    ...
                    <div className="p-6">
                      ...
                      <Button 
                        className="w-full bg-gradient-to-r from-green-600 to-orange-500 hover:from-green-700 hover:to-orange-600 text-white py-4 text-sm"
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="bg-gradient-to-r from-green-600 via-emerald-600 to-orange-500 text-white">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-green-600 via-emerald-600 to-orange-500 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
